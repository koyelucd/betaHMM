...
## ----betaHMMplot,include=TRUE, echo=TRUE--------------------------------------
AUC_chr <- AUC(dmc_out)
plot(betaHMM_out, chromosome = "7", what = "fitted density", AUC = AUC_chr)

## ----betaHMMplot2,include=TRUE, echo=TRUE-------------------------------------
...
## ----dmrplot,include=TRUE, echo=TRUE------------------------------------------
...
## ----thresholdplot,include=TRUE, echo=TRUE------------------------------------

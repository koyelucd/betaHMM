...
#'
#' @description A dataset containing simulated beta methylation values from
...
#' \href{https://github.com/koyelucd/betaHMM}{GitHub}.
#' @seealso \code{\link{sample_annotation_file}}
#' @format A data frame with 100 rows and 9 columns. The data contain no
#' missing values.
#' \itemize{
...
#' patient 4.}}
#' @usage data(sample_methylation_file)
#' @return The data frame containing simulated methylation values.
